...
Q1 = 2.989830; % bifurcation parameter
% Q1 = 2.989835;
...
% end
% t = t(1:3:end);
% ts_predict = ts_predict(1:3:end,:);
% x_warmup = ts_predict( warmup_r_step_cut+1 : warmup_r_step_cut+warmup_r_step_length, :);



%% read data
load("../data/voltage_Q12.989830.mat")

warmup_r_step_cut = 2650-512;
warmup_r_step_length = 512;
x_warmup = traj(warmup_r_step_cut:warmup_r_step_cut+warmup_r_step_length, :);
...
% save('predict_r_voltage.mat','predict_r')
